...
TOKEN = 'MTIyNTQxMDQzNTMwMjQyNDYwNg.GjI9qc.lYSWUPyMt4LCc0OOAtOX99ly7p_jmxsMFHL_Kg'

# Replace 'Ruby's Channel ID' with the actual channel ID
ruby_channel_id = 1225410504755777602
...
async def check_log_and_send():
    ...
    while True:
        ...
        if (message != checker) and (message != ''):
            channel = client.get_channel(ruby_channel_id)
            if channel:
